...
const TIMES = (process.env.STILL_TIMES ||
  "2.0 3.8 6.2 7.6 8.9 9.8 10.9 12.2 13.5 21.4 23.4 29.3 33.8 36.8 39.6 47.5 53.9 56.8 62.9 67.5 75.2 78.7 83.0 91.5 106.4 117.4 133.4 142.2 151.4 156.8 164.9 174.2")
  .split(/\s+/)
  .filter(Boolean)
  .map(Number);
