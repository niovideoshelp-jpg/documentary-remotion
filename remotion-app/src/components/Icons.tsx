...
export const ICONS = {
  ...
  // guided bomb, nose right: slim body, cruciform tail, mid strakes, seeker head
  bomb: {
    s: ["M18,50 L26,43 L74,43 C84,43 92,46 96,50 C92,54 84,57 74,57 L26,57 Z", "M26,43 L14,31 L24,31 L34,43 M26,57 L14,69 L24,69 L34,57", "M54,43 L58,36 L68,36 L66,43 M54,57 L58,64 L68,64 L66,57"],
    f: ["M84,44 C90,46 94,48 96,50 C94,52 90,54 84,56 Z"],
  },
  shield: {
  ...
  // small fixed-wing drone, top view, nose right: long straight wings, V-tail, pusher prop
  drone: {
    s: ["M22,50 C22,46 32,45 60,45 C74,45 84,47 90,50 C84,53 74,55 60,55 C32,55 22,54 22,50 Z", "M54,45 L48,8 L57,8 L63,45 M54,55 L48,92 L57,92 L63,55", "M28,47 L16,33 L21,31 L34,46 M28,53 L16,67 L21,69 L34,54", "M16,40 L16,60"],
  },
