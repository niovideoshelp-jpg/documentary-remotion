      ...
      <PaperGround>
        <Camera s={keys(t, [[92, 1.06], [99.2, 1.0]], ease.soft)} x={keys(t, [[92, -60], [99.2, 40]], ease.soft)}>
          <Layer>
            ...
            <Card t={t} at={97.5} src="src-photos/stormshadow-side.jpg" name="Storm Shadow" x={1440} y={830} w={560} h={250} pos="45% 40%" zoom={1.15} rot={-1} />
          </Layer>
        </Camera>
      </PaperGround>
    </BlotReveal>
      ...
      <PaperGround>
        <Camera s={keys(t, [[99.1, 1.06], [106.5, 1.0], [108.6, 1.04], [112.4, 1.06]], ease.soft)} x={keys(t, [[99.1, 60], [106.5, 0], [108.6, 140], [112.4, 160]], ease.inOut)}>
          <Layer>
            ...
            <Card t={t} at={105.6} src="src-photos/stormshadow-side.jpg" name="SCALP" x={1130} y={690} w={440} h={270} pos="45% 40%" zoom={1.15} rot={1} dark />
        ...
        <Camera s={keys(t, [[152.4, 1.08], [157.5, 1.0], [163.5, 1.04], [171.7, 1.0]], ease.soft)}>
          <Layer>
            ...
            <AbsoluteFill style={{ opacity: photo }}>
              <Photo src="src-photos/stormshadow-side.jpg" x={W / 2} y={500} w={1100} h={440} zoom={1.08} objectPosition="45% 40%" reveal={ramp(t, 157.6, 158.3)} revealFrom="bottom" seed="ss" />
              <At x={W / 2} y={200}>
